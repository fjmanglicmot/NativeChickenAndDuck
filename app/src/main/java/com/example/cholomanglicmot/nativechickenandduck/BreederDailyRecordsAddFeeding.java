...
public class BreederDailyRecordsAddFeeding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breeder_daily_records_add_feeding);
        ...
        feeding_date_collected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(BreederDailyRecordsAddFeeding.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
