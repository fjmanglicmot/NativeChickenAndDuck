...
public class RecyclerAdapter_Brooder_Growth extends RecyclerView.Adapter<RecyclerAdapter_Brooder_Growth.RecyclerViewHolder> {


    ArrayList<Brooder_GrowthRecords> arrayListBrooderGrowthRecords = new ArrayList<>();

    RecyclerAdapter_Brooder_Growth(ArrayList<Brooder_GrowthRecords> arrayListBrooderGrowthRecords){
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.brooder_growth_row_layout,parent, false);
